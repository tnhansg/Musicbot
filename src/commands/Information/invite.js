...
module.exports = {
  ...
  execute: async (message, args, client, prefix) => {
    ...
    const mainPage = new EmbedBuilder()
      ...
      .setColor(0x303236)
      .addFields([{ name: 'invite Thien Nhan ✨', value: `[Here](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=36768832&scope=applications.commands%20bot)` }])
